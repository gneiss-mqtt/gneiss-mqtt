...
use gneiss_mqtt::client::config::AsyncWebsocketOptions;
...
/// connect-websockets-tokio - an example connecting to an MQTT broker with TLS over websockets using a tokio-based client
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let ws_options = AsyncWebsocketOptions::builder().build();
